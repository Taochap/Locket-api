...
def spam_friend_request():
    ...
    return jsonify({'status': 'success', 'message': 'Friend request spamming initiated.'})
...
def delete_friend_request():
    ...
    return jsonify({'status': 'success', 'message': f'Successfully deleted {deleted_count} friend requests.'})
